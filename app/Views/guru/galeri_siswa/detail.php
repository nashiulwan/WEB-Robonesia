...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="<?= base_url('guru/galeri'); ?>" class="btn btn-warning" style="margin-right: 10px;" title='kembali'><i class="fas fa-arrow-left"></i></a>
            <a href="<?= base_url('guru/galeri/tambah/' . esc($user['id'])); ?>" class="btn btn-primary" title='tambah foto'><i class="fas fa-plus"></i></a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                                    <a href="<?= base_url('guru/galeri/edit/' . esc($user['id']) . '/' . esc($row['id'])); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form action="<?= base_url('guru/galeri/delete/' . esc($user['id']) . '/' . esc($row['id'])); ?>" method="post">
                                        <?= csrf_field(); ?>
