...
<div class="container-fluid">
    ...
    <form action="<?= base_url('guru/galeri/simpan/' . esc($user['id'])) ?>" method="post" enctype="multipart/form-data" autocomplete="off">
        <?= csrf_field() ?>
        ...
        <a href="<?= base_url('guru/galeri_siswa') ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
    </form>
</div>
