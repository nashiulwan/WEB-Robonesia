...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= base_url('guru/sertifikat/akun/tambah/' . esc($user['id'])); ?>" class="btn btn-primary">Tambah Sertifikat</a>
  </div>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                  <a href="<?= base_url('guru/sertifikat/akun/edit/' . esc($user['id'])) . '/' . esc($row['id']); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                    <i class="fas fa-pen"></i>
                  </a>
                  <form action="<?= base_url('guru/sertifikat/akun/delete/' . esc($user['id'])) . '/' . esc($row['id']); ?>" method="post">
                    <?= csrf_field(); ?>
