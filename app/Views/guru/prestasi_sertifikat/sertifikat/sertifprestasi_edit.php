...
<div class="container-fluid">
  ...
  <form action="<?= base_url('guru/sertifikat/prestasi/update/' . esc($prestasiId) . '/' . esc($sertifikat['id'])) ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    ...
    <a href="<?= base_url('guru/sertifikat/prestasi/' . esc($prestasiId)) ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
  </form>
</div>
