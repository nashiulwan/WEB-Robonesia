...
<div class="container-fluid">
  ...
  <form action="<?= base_url('guru/sertifikat/update/' . esc($sertifikat['id'])) ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    ...
    <a href="<?= base_url('guru/sertifikat') ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
  </form>
</div>
