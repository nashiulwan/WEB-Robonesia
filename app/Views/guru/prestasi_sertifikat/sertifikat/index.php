                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                                            <a href="<?= base_url('guru/sertifikat/detail/' . esc($sertifikat['id'])); ?>" class="btn btn-primary btn-sm" title="Detail" style="width: 32px; height: 32px; margin: 2px">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?= base_url('guru/sertifikat/edit/' . esc($sertifikat['id'])); ?>" class="btn btn-warning btn-sm" title="Edit" style="width: 32px; height: 32px; margin: 2px">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <form action="<?= base_url('guru/sertifikat/delete/' . esc($sertifikat['id'])); ?>" method="post">
                                                <?= csrf_field(); ?>
                        ...
                        <?php if (!empty($prestasis)): ?>
                            <?php foreach ($prestasis as $prestasi): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                                            <a href="<?= base_url('guru/sertifikat/prestasi/' . esc($prestasi['id'])); ?>" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                        ...
                        <?php if (!empty($users)) : ?>
                            <?php foreach ($users as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                                            <a href="<?= base_url('guru/sertifikat/akun/' . esc($row['id'])); ?>" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                                                <i class="fas fa-award"></i>
                                            </a>
                                        </div>
                                    </td>
                        ...
                        <?php if (!empty($prestasis)): ?>
                            ...
                            <?php foreach ($kelas as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                                            <a href="<?= base_url('guru/sertifikat/kelas/' . esc($row['id'])); ?>" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                                                <i class="fas fa-award"></i>
                                            </a>
                                        </div>
                                    </td>
