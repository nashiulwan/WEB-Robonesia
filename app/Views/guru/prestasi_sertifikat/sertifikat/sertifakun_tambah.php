...
<div class="container-fluid">
  ...
  <form action="<?= base_url('guru/sertifikat/akun/simpan/' . esc($user['id'])) ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    ...
    <a href="<?= base_url('guru/sertifikat/akun/' . esc($user['id'])) ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
  </form>
</div>
