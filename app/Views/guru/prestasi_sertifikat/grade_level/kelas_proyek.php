...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= base_url('guru/grade_level/proyek/tambah/' . esc($kelas['id'])) ?>" class="btn btn-primary">
      Tambah Proyek
    </a>
  </div>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                  <a href="<?= base_url('guru/grade_level/proyek/edit/' . esc($kelas['id']) . '/' . esc($img['id'])) ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;  margin-bottom: 10px;">
                    <i class="fas fa-pen"></i>
                  </a>
                  <a href="<?= base_url('guru/grade_level/proyek/delete/' . esc($kelas['id']) . '/' . esc($img['id'])) ?>" class="btn btn-danger btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;" onclick="return confirm('Apakah Anda yakin ingin menghapus proyek ini?');">
