    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="daftar-prestasi" role="tabpanel" aria-labelledby="daftar-prestasi-tab">
            <div class="mb-3 d-flex align-items-center justify-content-between">
                ...
                <a href="<?= base_url('guru/prestasi/tambah'); ?>" class="btn btn-primary" id="tambahPrestasiBtn">Tambah Prestasi</a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                                            <a href="<?= base_url('guru/prestasi/detail/' . esc($prestasi['id'])); ?>" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?= base_url('guru/prestasi/edit/' . esc($prestasi['id'])); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <form action="<?= base_url('guru/prestasi/delete/' . esc($prestasi['id'])); ?>" method="post">
                                                <?= csrf_field(); ?>
                            ...
                            <?php foreach ($users as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('guru/prestasi/prestasi_detail/' . $row['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-trophy"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
