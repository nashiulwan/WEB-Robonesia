...
<div class="container-fluid">
  ...
  <form action="<?= base_url('guru/prestasi/simpan') ?>" method="post" autocomplete="off">
    <?= csrf_field() ?>
    ...
    <a href="<?= base_url('guru/prestasi/detail') ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
  </form>
</div>
