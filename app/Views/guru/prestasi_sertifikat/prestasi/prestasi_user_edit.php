...
<div class="container-fluid">
  ...
  <!-- Form edit prestasi -->
  <form action="<?= base_url('guru/prestasi/prestasi_detail/update/' . esc($user['id']) . '/' . esc($prestasi['id'])) ?>" method="post" autocomplete="off">
    <?= csrf_field() ?>
    <!-- Hidden field -->
    ...
    <div class="form-group mb-3">
      ...
      <a href="<?= base_url('guru/prestasi/prestasi_detail/' . esc($user['id'])) ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
  </form>
</div>
