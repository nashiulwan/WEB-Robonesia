...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= base_url('guru/prestasi/tambah_prestasi/' . esc($user['id'])); ?>" class="btn btn-primary">Tambah Prestasi Siswa</a>
  ...
  <div class="mb-3 d-flex align-items-center justify-content-between">
    ...
    <a href="<?= base_url('guru/prestasi/'); ?>" class="btn btn-warning" id="tambahPrestasiBtn" style="width:7rem">Kembali</a>
  </div>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex flex-wrap gap-2" style="justify-content: space-between;">
                  <a href="<?= base_url('guru/prestasi/prestasi_detail/info/' . esc($user['id']) . '/' . esc($prestasi['id'])); ?>" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                    <i class="fas fa-eye"></i>
                  </a>
                  <a href="<?= base_url('guru/prestasi/prestasi_detail/edit/' . esc($user['id']) . '/' . esc($prestasi['id'])); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; margin: 2px;">
                    <i class="fas fa-pen"></i>
                  </a>
                  <form action="<?= base_url('guru/prestasi/prestasi_detail/delete/' . esc($prestasi['id'])); ?>" method="post">
                    <?= csrf_field(); ?>
