...
<div class="container-fluid my-4">
  ...
  <form action="<?= base_url('guru/prestasi/update/' . esc($prestasi['id'])) ?>" method="post" autocomplete="off">
    <?= csrf_field() ?>
    ...
    <a href="<?= base_url('guru/prestasi') ?>" class="btn btn-warning" style="width:7rem">Kembali</a>
  </form>
</div>
