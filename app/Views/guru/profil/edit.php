...
<div class="container-fluid">
    ...
    <form action="<?= base_url('guru/profil/update') ?>" method="post" enctype="multipart/form-data">
        ...
        <small>
            <span class="text-danger">***</span> Jika Anda lupa password lama dan ingin menggantinya, silakan hubungi guruistrator melalui
        ...
        <a href="<?= base_url('guru/profil') ?>" class="btn btn-warning ms-2" style="width:7rem">Kembali</a>
    </form>
</div>
