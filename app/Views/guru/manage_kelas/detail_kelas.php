...
<div class="container-fluid my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= base_url('guru/manage_kelas/kelola_anggota') ?>" class="btn btn-warning" style="margin-left:10px; width:7rem">Kembali</a>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3" style="padding-top: 1rem;">
        ...
        <a href="<?= base_url('guru/manage_kelas/kelola_anggota/tambah/' . esc($class['id'])); ?>" class="btn btn-primary">Tambah Anggota</a>
    </div>
