...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3" style="padding-top: 1rem;">
        ...
        <a href="<?= base_url('guru/manage_kelas/kelola_anggota/detail/' . esc($kelas['id'])); ?>" class="btn btn-warning" style="margin-left:10px; width:7rem">Kembali</a>
    </div>
                    ...
                    <?php foreach ($nonMembers as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="<?= base_url('guru/manage_kelas/kelola_anggota/tambah_anggota'); ?>" method="post" onsubmit="return confirm('Tambah akun ini ke kelas?')">
                                    <?= csrf_field(); ?>
