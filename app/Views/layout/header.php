...
<html lang="en">
  ...
  <head>
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-3136K9BEW1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-3136K9BEW1');
  </script>
...
<body>
  ...
  <div class="floating-buttons">
    ...
    <a href="shop" class="btn-floating btn-shop" title="Shop">
