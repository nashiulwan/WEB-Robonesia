    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-6">
        <div class="small-box text-bg-success">
          ...
          <a style="z-index:0" href="https://analytics.google.com/analytics/web/" target="_blank" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
      ...
      <div class="col-lg-4 col-6">
        <div class="small-box text-bg-warning">
          ...
          <a style="z-index:0" href="/admin/manage_akun" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
      ...
      <div class="col-lg-4 col-6">
        <div class="small-box text-bg-danger">
          ...
          <a style="z-index:0" href="/admin/artikel" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
...
document.addEventListener("DOMContentLoaded", function () {
    fetch('/admin/analytics/getTotalVisitors')
