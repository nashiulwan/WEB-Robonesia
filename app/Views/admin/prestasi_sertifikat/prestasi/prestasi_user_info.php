...
<div class="container-fluid my-4">
  ...
  <div class="card shadow-sm">
    <div class="card-body table-responsive">
      <table class="table table-borderless table-striped table-detail" style="color: black;">
        <tr>
          ...
          <td><?= esc($owner['fullname']) ?></td>
        </tr>
        <tr>
          <th>Asal Sekolah</th>
          <td><?= esc($owner['asal_sekolah']) ?></td>
        </tr>
        <tr>
          <th>Kelas</th>
          <td><?= esc($owner['kelas']) ?></td>
        </tr>
        <tr>
    ...
    <a href="<?= base_url('admin/prestasi/prestasi_detail/' . esc($owner['id'])) ?>" class="btn btn-warning" style="margin-left:20px; margin-bottom:1rem;width:7rem">Kembali</a>
  </div>
</div>
<?= $this->endSection() ?>