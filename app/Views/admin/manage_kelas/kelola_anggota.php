...
<style>
    ...
    .card:hover a {
        text-decoration: none;
        /* Pastikan garis bawah hilang juga saat hover */
    }
    ...
    /* CSS untuk mengubah warna gradient secara acak pada setiap card */
    .card:nth-child(1) .wave-top path {
        fill: url(#sw-gradient-0);
    }

    .card:nth-child(2) .wave-top path {
        fill: url(#sw-gradient-1);
    }

    .card:nth-child(3) .wave-top path {
        fill: url(#sw-gradient-2);
    }

    .card:nth-child(4) .wave-top path {
        fill: url(#sw-gradient-3);
    }

    .card:nth-child(5) .wave-top path {
        fill: url(#sw-gradient-4);
    }

    .card:nth-child(6) .wave-top path {
    ...
    /* CSS untuk mengubah warna gradient secara acak pada setiap card */
    .card:nth-child(1) .wave path {
        fill: url(#sw-gradient-0);
    }

    .card:nth-child(2) .wave path {
        fill: url(#sw-gradient-1);
    }

    .card:nth-child(3) .wave path {
        fill: url(#sw-gradient-2);
    }

    .card:nth-child(4) .wave path {
        fill: url(#sw-gradient-3);
    }

    .card:nth-child(5) .wave path {
        fill: url(#sw-gradient-4);
    }

    .card:nth-child(6) .wave path {
        fill: url(#sw-gradient-5);
    }
</style>
            ...
            <?php if (!empty($classes)) : ?>
                <?php foreach ($classes as $row) : ?>
                    <div class="card shadow mb-4">
                        <svg class="wave-top" id="wave-top" style="transform:rotate(180deg); transition: 0.3s" viewBox="0 0 1440 180" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                        ...
                        <svg id="wave" class="wave" style="transform:rotate(0deg); transition: 0.3s" viewBox="0 0 1440 300" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                                    <stop stop-color="#25D366" offset="0%"></stop>
                                    <stop stop-color="#ffdd00" offset="100%"></stop>
...
<script>
    ...
    searchInput.addEventListener('input', function() {
        const searchTerm = searchInput.value.toLowerCase(); // Ambil nilai pencarian dan ubah jadi lowercase

        cards.forEach(function(card) {
            const className = card.querySelector('.card-title').textContent.toLowerCase(); // Ambil nama kelas dari card

            // Bandingkan nama kelas dengan input pencarian
            if (className.includes(searchTerm)) {
                card.style.display = 'block'; // Tampilkan card jika sesuai
            } else {
