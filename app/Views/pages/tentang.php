...
<header class="header__tentang">
  ...
  <div class="tentang__container">
    <section>
      ...
      <img src="/image/about.jpg" alt="Tentang Kami" class="header__tentang__img">
    </section>
    <section>
      <img src="/image/about2.jpg" alt="Tentang Kami" class="header__tentang__img">
      <p><span>Program Pembelajaran yang Terjangkau dan Berkualitas</span>
    ...
    <section>
      <img src="/image/about3.jpg" alt="Tentang Kami" class="header__tentang__img">
      <p><span>Mari Bergabung dan Wujudkan Masa Depan Bersama
        </span>
...
<main>
  ...
  <section class="tentang__visi-misi">
    ...
    <ul>
      <li>Menumbuhkan integritas dalam diri anak anak dengan mengarahkan potensi anak melalui pembelajaran berbasis projek
      </li>
      <li>Melatih anak-anak agar memiliki keterampilan dalam teknologi dan sains</li>
      <li>Menyediakan alat pelatihan yang sesuai dengan tumbuh kembang anak</li>
    </ul>
  </section>
  ...
  <section class="sejarah__container">
    <h1>Sejarah Kami</h1>
    <img src="/image/logo.png" alt="Sejarah Kami" class="sejarah__img">
    <p>
